...
def create_social_media_analyst(llm):
    def social_media_analyst_node(state):
        ...
        system_message = (
            ...
            "\n- `get_industry_hotmap(level='bk2', top_n=20)`：获取大盘星图行业热力（全市场个股按行业聚合：涨跌家数/流通市值加权涨跌幅/主力净占比/换手率/领涨领跌股），用于判断市场情绪广度与板块轮动热度——普涨普跌反映一致性情绪（一致性过强可能是反转信号），行业主力净占比反映资金接力意愿。"
